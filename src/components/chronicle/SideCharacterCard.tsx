...
export const SideCharacterCard: React.FC<SideCharacterCardProps> = ({
  ...
  return (
    <div className={`rounded-2xl transition-all duration-300 border-2 backdrop-blur-sm relative ${isDarkBg ? 'bg-ghost-white border-transparent hover:bg-ghost-white' : 'bg-black/30 border-transparent hover:bg-black/50'} ${isUpdating ? 'ring-2 ring-blue-500/60' : ''}`}>
