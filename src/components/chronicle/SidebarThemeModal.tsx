    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-4xl p-0 bg-zinc-900 border-white/10 shadow-[0_12px_32px_-2px_rgba(0,0,0,0.5)] [&>button]:hidden">
        ...
        <div className="flex justify-between items-center px-6 pt-6 pb-4 border-b border-white/10">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                className="inline-flex items-center bg-zinc-700 text-white hover:bg-zinc-600 font-bold text-[10px]0px] tracking-widest uppercase h-9 gap-1 px-3 rounded-lg transition-colors disabled:opacity-50"
        ...
        <div className="px-6 pb-6">
          ...
          {/* Grid */}
          <div className="max-h-[460px] overflow-y-auto  pt-2pr-1">
