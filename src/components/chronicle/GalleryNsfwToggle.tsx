...
import { useGalleryNsfwAgeConfirmation } from '@/hooks/use-gallery-nsfw-preference';
...
export const GalleryNsfwToggle: React.FC<GalleryNsfwToggleProps> = ({
  ...
  const handleToggleChange = (nextChecked: boolean) => {
    ...
    // Gate the first opt-in behind a local 18+ confirmation, but do not
    // prompt again after the user has already confirmed once on this device.
    if (hasConfirmedNsfw) {
