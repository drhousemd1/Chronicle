          ...
          >
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="min-h-[120px] resize-none bg-[#1c1c1f] border border-black/35 rounded-lg text-[#eaedf1] placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
