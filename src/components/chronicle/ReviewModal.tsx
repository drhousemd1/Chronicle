...
import { submitReview, type ScenarioReview } from '@/services/gallery-data';
          ...
          <div className="relative w-full max-w-lg max-h-[90vh] bg-[#121214] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/10 overflow-hidden flex flex-col">
            ...
            <div className="p-5 border-t border-white/10">
              <button
                ...
                className="w-full h-11 bg-[#4a5f7f] hover:bg-[#3d5170] disabled:opacity-40 disabled:cursor-not-allowed text-white rounded-xl font-semibold text-sm transition-colors flex items-center justify-center gap-2"
              >
