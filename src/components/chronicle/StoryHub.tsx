      ...
      <div className="aspect-[2/3] w-full overflow-hidden rounded-[2rem] bg-slate-200 !shadow-[0_12px_32px_-2px_rgba(0,0,0,0.50)] transition-shadow duration-300 group-hover:shadow-2xl border border-[#4a5f7f] relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center gap-2 px-4 opacity-0 group-hover:opacity-100 transition-all duration-300 z-10 scale-90 group-hover:scale-100 flex-wrap">
          <button 
            ...
            className="h-8 px-4 rounded-xl bg-white text-[hsl(var(--ui-surface-2))] hover:bg-slate-50 text-[10px] font-bold leading-none uppercase tracking-wider shadow-2xl transition-colors"
          >
            Edit
          </button>
          <button 
