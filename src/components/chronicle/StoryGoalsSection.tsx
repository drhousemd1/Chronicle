                ...
                <div className="p-5 pb-6 bg-[#3a3a3f]/30 rounded-2xl border border-blue-500/20 relative">
                  ...
                  <div className="mt-4">
                    ...
                    <AutoResizeTextarea
                      ...
                      rows={2}
                      className={cn("px-3 py-2 text-sm bg-zinc-900/50 border text-white placeholder:text-zinc-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500", hasError && !goal.desiredOutcome.trim() ? 'border-red-500 ring-2 ring-red-500' : 'border-zinc-700')}
                    />
