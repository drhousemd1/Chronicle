  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <input
        ...
        spellCheck={true}
        className={cn("w-full rounded-2xl border border-slate-200 bg-ghost-white px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all", className, "w-full")}
      />
    </div>
  );
}
  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <textarea
        ...
        rows={rows}
        spellCheck={true}
        className={cn("w-full rounded-2xl border border-slate-200 bg-ghost-white px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all", autoResize ? 'resize-none overflow-hidden' : 'resize-none', className, "w-full")}
      />
    </div>
  );
}
