    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="rounded-2xl bg-[hsl(240_6%_10%)] border border-[hsl(0_0%_100%_/_0.10)] shadow-[0_10px_30px_hsl(0_0%_0%_/_0.5)] max-w-lg">
        ...
        <AlertDialogFooter className="gap-2 sm:gap-2">
          ...
          <AlertDialogAction
            onClick={onConfirm}
            className="rounded-xl bg-[hsl(var(--destructive))] hover:brightness-110 text-[hsl(var(--destructive-foreground))] border-0 h-10 px-6 text-[10px] font-bold leading-none uppercase tracking-wider shadow-[0_10px_30px_hsl(0_0%_0%_/_0.35)]"
          >
            Delete
          </AlertDialogAction>
        </AlertDialogFooter>
