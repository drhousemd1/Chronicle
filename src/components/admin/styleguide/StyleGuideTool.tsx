          ...
          <Section id="colors" title="Colors" desc="All colors organized by the page they appear on. Every value verified against live source code and CSS custom properties.">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(320px,1fr))', gap: 14 }}>
              ...
              <SwatchCardV2 color="#2a2a2f" name="Dark Charcoal" locations="Panel containers, Character Roster sidebar, character cards" value="#2a2a2f" token="bg-[#2a2a2f]" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Panel containers', function: 'Background for collapsible section containers (Story Card, World Core, Story Arcs, etc.)' },
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Character Roster sidebar', function: 'Background for the CHARACTER ROSTER sidebar and ADD/CREATE character cards' },
              ]} />
              <SwatchCardV2 color="#1a1a1a" name="Soft Black" locations="Left icon navigation sidebar" value="#1a1a1a" token="bg-[#1a1a1a]" pageSpecific={true} appWide={false} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Left icon navigation sidebar', function: 'Background color for the left navigation sidebar containing page links (My Stories, Character Library, etc.)' },
              ]} />
              <SwatchCardV2 color="hsl(228, 7%, 20%)" name="Graphite" locations="Story Setup heading, header titles, DRAFTS, SAVE AND CLOSE, SAVE DRAFT, Upload Image, header action buttons, secondary button text, ghost button hover" value="hsl(228 7% 20%)" token="text-[hsl(var(--ui-surface-2))]" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Story Setup heading', function: 'Text color for the main "Story Setup" page heading' },
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'DRAFTS / SAVE AND CLOSE / SAVE DRAFT buttons', function: 'Text color for header action buttons in the top-right toolbar' },
              ]} />
              <SwatchCardV2 color="rgba(248,250,252,0.3)" name="Ghost White" locations="Top header bar backgrounds, Main content area behind panels, Story card stats, 'Created by' text, form labels, loading text, checkbox labels, Story card description, folder description, sidebar chevrons, empty state text, unpublish button, character labels, model subtitle, review score" value="rgba(248,250,252,0.3)" token="text-[rgba(248,250,252,0.3)] / bg-[rgba(248,250,252,0.3)]" pageSpecific={false} appWide={true} extraPreviewStyle={{ border: '1px dashed #ccc' }} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Header bar background', function: 'Semi-transparent background tint for the top header bar containing STORY BUILDER title and action buttons' },
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Form labels', function: 'Text color for field labels like STORY NAME, BRIEF DESCRIPTION, STORY PREMISE, etc.' },
              ]} />
              <SwatchCardV2 color="#64748b" name="Cool Gray" locations="Subtitle text below page headings" value="#64748b" token="text-slate-500" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Subtitle text', function: 'Text color for the subtitle "Configure the foundation of your interactive narrative." below the Story Setup heading' },
              ]} />
              <SwatchCardV2 color="rgba(24,24,27,0.5)" name="Smoke Black" locations="All text inputs, textareas, bullet-list containers" value="rgba(24,24,27,0.5)" token="bg-zinc-900/50" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Text input fields', function: 'Background for all text inputs and textareas (Story Name, Brief Description, Story Premise, etc.)' },
              ]} />
              <SwatchCardV2 color="#3f3f46" name="Mid Charcoal" locations="Input borders, textarea borders, tag chip borders" value="#3f3f46" token="border-zinc-700" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Input borders', function: 'Border color for text inputs and textareas throughout the builder' },
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/tags-area.png', location: 'Tag chip borders', function: 'Border color for genre, origin, and trigger warning tag chips' },
              ]} />
              <SwatchCardV2 color="#3b82f6" name="True Blue" locations="Art Style checkmark badge, guidance box border, Play button on card hover, tag badges, Open buttons, Plus buttons, reposition overlay, Chronicle logo, Provider label, Learn More link, day counter arrows, time-of-day active state, arc flow connectors, Save buttons, '+ Add' links, active slider labels, SFW badge text, user message bubble border, dashed add button text, sparkle icon hover, character name hover, AI/Player toggle, focus rings on style selectors, input focus borders" value="#3b82f6" token="bg-blue-500 / text-blue-500 / border-blue-500 / ring-blue-500" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/artstyle-codex.png', location: 'Art Style checkmark badge', function: 'Blue checkmark overlay on the selected art style card (e.g. Cinematic 2.5D)' },
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/mid-section.png', location: '+ Add links and dashed button text', function: 'Text color for "+ Add Location", "+ Add Custom Content", and "+ Add New Story Arc" action links' },
              ...
              <SwatchCardV2 color="#a1a1aa" name="Silver Gray" locations="Trash icons, tag chip text, inactive tab text" value="#a1a1aa" token="text-zinc-400" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/tags-area.png', location: 'Tag chip text', function: 'Text color for genre, origin, and trigger warning tag chip labels' },
              ]} />
              <SwatchCardV2 color="#71717a" name="Stone Gray" locations='Dashed "add" button borders, inactive slider labels' value="#71717a" token="border-zinc-500" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/tags-area.png', location: 'Dashed "add" button borders', function: 'Dashed border around "+ Add custom" buttons in Content Themes sections' },
              ...
              <SwatchCardV2 color="#27272a" name="Dark Zinc" locations="Genre/Origin/Type tag chips, art style card backgrounds, character avatar, Story card gradient overlay, admin card gradient, folder card gradient, loading screen background" value="#27272a" token="bg-zinc-800" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/tags-area.png', location: 'Genre/Origin tag chips', function: 'Background for genre, origin, and character type tag chip pills' },
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/artstyle-codex.png', location: 'Art style card backgrounds', function: 'Background behind art style thumbnail images in the Art Style Preference section' },
              ]} />
              <SwatchCardV2 color="hsl(210, 20%, 93%)" name="Pale Silver" locations="Shadow Surface button text, dark panel text" value="hsl(210 20% 93%)" token="text-[hsl(var(--ui-text))]" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Upload Image button text', function: 'Text color for Shadow Surface variant buttons like "Upload Image" on dark panel backgrounds' },
              ]} />
              <SwatchCardV2 color="#e2e8f0" name="Light Steel" locations="Header bar bottom border" value="#e2e8f0" token="border-slate-200" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Header bar bottom border', function: 'Subtle bottom border line separating the STORY BUILDER header from the page content below' },
              ]} />
              ...
              <SwatchCardV2 color="#d4d4d8" name="Light Zinc" locations="Bullet list text in World Codex Dialog Formatting" value="#d4d4d8" token="text-zinc-300" pageSpecific={false} appWide={true} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/artstyle-codex.png', location: 'Bullet list text', function: 'Text color for the dialog formatting bullet list in World Codex (e.g. "Enclose all spoken dialogue in \" \"")' },
              ]} />
              <SwatchCardV2 color="rgba(255,255,255,0.1)" name="Faint White" locations="Button borders, panel outer borders, character card borders" value="rgba(255,255,255,0.1)" token="border-white/10" pageSpecific={false} appWide={true} extraPreviewStyle={{ border: '1px dashed #999' }} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Panel outer borders', function: 'Subtle outer border on panel containers (Story Card, World Core) and character cards in the roster sidebar' },
              ]} />
              <SwatchCardV2 color="rgba(255,255,255,0.2)" name="Dim White" locations="Panel header bar bottom border" value="rgba(255,255,255,0.2)" token="border-white/20" pageSpecific={false} appWide={true} extraPreviewStyle={{ border: '1px dashed #999' }} locationImages={[
                { url: 'https://gialzvvswxadxolnwots.supabase.co/storage/v1/object/public/guide_images/story-builder/main-view.png', location: 'Panel header bar bottom border', function: 'Border separating the slate-blue header bar from the panel body content below (e.g. Story Card header from form fields)' },
              ]} />
            </div>
