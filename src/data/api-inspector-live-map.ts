        ...
        groups: [
          {
            ...
            items: [
              ...
              {
                id: "assistant-style-telemetry",
                title: "Local assistant style telemetry",
                tag: "validation",
                summary:
                  "When the client detects repetition or response-shape issues after a completed draft, it records local detector telemetry for the debug export without sending another Grok request or changing the visible response.",
                fileRefs: [
                  ref("/src/components/chronicle/ChatInterfaceTab.tsx", "assistant style telemetry record"),
                  ref("/src/lib/assistant-style-directive.ts", "assistant style telemetry analysis"),
                  ref("/src/features/chat-debug/review-export.ts", "assistant style telemetry rendering"),
                ],
                bullets: [
                  bullet("Runtime effect", "The first completed draft stays committed unless the provider request itself fails."),
                  bullet("Scope", "This is a local diagnostic record saved as local://assistant-style-telemetry, not a prompt injection and not a user-visible message."),
                ],
