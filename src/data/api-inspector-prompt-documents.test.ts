...
describe("api-inspector prompt document registry", () => {
  ...
  it("keeps API Call 1 documented as source-backed current prompt text", () => {
    ...
    expect(document.body).toContain("Write the next response from what is actively happening right now.");
    expect(document.body).toContain("Use story cards, character cards, memories, and goals as supporting context.");
    expect(document.body).toContain("Do not pull in background details unless they logically matter to the current scene.");
