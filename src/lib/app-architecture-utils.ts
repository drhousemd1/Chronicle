...
const FOLDER_DESCRIPTIONS: Array<{ pattern: RegExp; description: string }> = [
  ...
  { pattern: /^\/src\/pages\/style-guide$/, description: "Standalone operator routes for App Architecture, Roleplay Pipeline, and Quality Hub." },
  { pattern: /^\/src\/features$/, description: "Feature-first domain modules. Each feature groups UI, utilities, and local types." },
  { pattern: /^\/src\/features\/story-builder$/, description: "Story Builder screen, extracted media subsystem, and roster sidebar ownership for scenario authoring." },
  { pattern: /^\/src\/features\/character-builder$/, description: "Character Builder screen plus its section rows, progress helpers, and sidebar navigation pieces." },
  { pattern: /^\/src\/features\/chat-debug$/, description: "Admin-only chat review/export helpers and turn-debug trace utilities scoped to roleplay observability." },
  ...
  { pattern: /^\/src\/components\/admin\/guide$/, description: "App Guide editing, freshness, and document navigation surfaces for the operator documentation tool." },
  { pattern: /^\/src\/components\/admin\/styleguide$/, description: "App Dashboard shell plus style-guide edit/download helpers that launch Chronicle's operator tools." },
  { pattern: /^\/src\/components\/admin\/finance$/, description: "Finance dashboard UI for business reporting, user access, API usage insights, and admin operations." },
  ...
  { pattern: /^\/src\/services\/persistence$/, description: "Domain-focused persistence modules for scenarios, conversations, side characters, media, and shared converters." },
  ...
  { pattern: /^\/supabase\/functions$/, description: "Supabase edge-function entry points plus shared backend helpers for chat, extraction, generation, telemetry, and admin tooling." },
  { pattern: /^\/supabase\/functions\/_shared$/, description: "Shared edge-runtime helpers such as CORS, rate limiting, and backend utility glue reused by multiple functions." },
  { pattern: /^\/scripts$/, description: "Local maintenance and validation scripts that refresh generated data or verify important app contracts." },
  { pattern: /^\/e2e$/, description: "End-to-end smoke coverage for the highest-level app routes and deployment sanity checks." },
  { pattern: /^\/docs$/, description: "Engineering and implementation documentation." },
  { pattern: /^\/docs\/guides$/, description: "Page-by-page and system-by-system maintenance guides used as operator documentation and code-truth references." },
  { pattern: /^\/docs\/guides\/mappings$/, description: "Structured mapping artifacts that support larger refactor planning and guide synchronization work." },
  { pattern: /^\/public$/, description: "Static public assets and HTML tools served directly by the app." },
  { pattern: /^\/public\/images$/, description: "Static illustration/reference assets for admin tools, backgrounds, and style-system media." },
  { pattern: /^\/public\/spellcheck$/, description: "Spellcheck dictionary assets fetched by Chronicle's chat composer spellcheck helper." },
];
