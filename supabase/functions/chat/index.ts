...
serve(async (req) => {
  ...
  try {
    ...
    // GROK ONLY -- Force any non-Grok model to grok-4-1-fast-non-reasoning
    ...
    const modelId = VALID_GROK_MODELS.includes(body.modelId) ? body.modelId : 'grok-4-1-fast-non-reasoning';
